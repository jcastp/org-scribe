...
(ert-deftest test-planner-single-plan-file-recognized ()
...
(ert-deftest test-planner-multiple-heading-file-not-plan ()
...
(ert-deftest test-planner-file-without-plan-properties-not-plan ()
...
(ert-deftest test-planner-empty-buffer-is-safe ()
...
(ert-deftest test-planner-single-plan-file-is-safe ()
...
(ert-deftest test-planner-multiple-heading-file-not-safe ()
...
(ert-deftest test-planner-save-plan-to-new-file ()
...
(ert-deftest test-planner-save-plan-updates-existing-plan-file ()
...
(ert-deftest test-planner-save-plan-refuses-multiple-heading-file ()
