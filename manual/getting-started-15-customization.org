...
1. Copy existing templates:
   #+BEGIN_SRC bash
   cp -r ~/.emacs.d/elpa/org-scribe-*/writing-templates/novel-en ~/my-templates/
   #+END_SRC
...
#+BEGIN_EXAMPLE
~/.emacs.d/elpa/org-scribe-VERSION/writing-templates/
#+END_EXAMPLE
...
*Online*:
- org-scribe issues: https://github.com/anthropics/claude-code/issues
- r/emacs community
- Emacs StackExchange
