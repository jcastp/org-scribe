...
#+BEGIN_SRC emacs-lisp
;; Default
(setq writing/sinonimo-window-width 80)
...
;; Synonym window width
(setq writing/sinonimo-window-width 70)  ; Adjust to your screen
#+END_SRC
...
(global-set-key (kbd "C-c w m") 'writing/distraction-free-mode)  ; Start writing
(global-set-key (kbd "C-c w e") 'writing/editing-mode)           ; Start editing
(global-set-key (kbd "C-c w w") 'writing-wordcount-subtree)      ; Count words
(global-set-key (kbd "C-c w n") 'writing/capture-to-file)        ; Quick note

;; Dictionary tools
(global-set-key (kbd "C-c d") 'writing/rae-api-lookup)           ; RAE dictionary
(global-set-key (kbd "C-c y") 'writing/sinonimo)                 ; Synonyms

;; Character/plot tools
(global-set-key (kbd "C-c l p") 'writing/set-pov-character)      ; Set PoV
(global-set-key (kbd "C-c l c") 'writing/set-scene-characters)   ; Set characters
(global-set-key (kbd "C-c l j") 'writing/jump-to-pov-character)  ; Jump to character

;; Search functions
(global-set-key (kbd "C-c s c") 'writing/org-find-character)     ; Find by character
(global-set-key (kbd "C-c s p") 'writing/org-find-plot)          ; Find by plot
(global-set-key (kbd "C-c s l") 'writing/org-find-location)      ; Find by location
#+END_SRC
...
(global-set-key (kbd "C-c m") 'hydra-writing/body)  ; Instead of F8 F8

;; Or add multiple bindings
(global-set-key (kbd "<f9>") 'hydra-writing/body)   ; F9 also opens it
#+END_SRC
...
;; Synonym window width
(setq writing/sinonimo-window-width 70)
...
;; Writing modes
(global-set-key (kbd "C-c w m") 'writing/distraction-free-mode)
(global-set-key (kbd "C-c w e") 'writing/editing-mode)
...
;; Character linking
(global-set-key (kbd "C-c l p") 'writing/set-pov-character)
(global-set-key (kbd "C-c l j") 'writing/jump-to-pov-character)

;; Hydra menu
(global-set-key (kbd "<f9>") 'hydra-writing/body)
...
*Congratulations on completing the entire emacs-writing tutorial series!* 🎉
