...
|-------------+-----------+-----------------------------+-------------------|
| PoV         | F8 F8 1   | ~writing/org-find-pov~        | ~:PoV:~             |
| Character   | F8 F8 2   | ~writing/org-find-character~  | ~:Characters:~      |
| Plot        | F8 F8 3   | ~writing/org-find-plot~       | ~:Plot:~            |
| Location    | F8 F8 4   | ~writing/org-find-location~   | ~:Location:~        |
...
Or use: ~M-x writing/org-find-pov~
...
Or use: ~M-x writing/org-find-character~
...
Or use: ~M-x writing/org-find-todos~
...
Run ~M-x writing/debug-scene-properties~ (if available) to diagnose.
...
|------------------------------+--------------------------|
| ~writing/org-find-pov~         | Search by PoV            |
| ~writing/org-find-character~   | Search by character      |
| ~writing/org-find-plot~        | Search by plot thread    |
| ~writing/org-find-location~    | Search by location       |
| ~writing/org-find-todos~       | Find all TODO items      |
...
(defun my/search-alex ()
  ...
  (interactive)
  (writing/org-find-pov "Alex Rivera"))
#+END_SRC
