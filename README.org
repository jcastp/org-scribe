...
*** Auto-Calculate Progress Tables

The package can automatically generate progress tables from your word count objectives and actual word counts.

**** Set Word Objectives

Add the =WORD-OBJECTIVE= property to your Acts, Chapters, or Scenes:
...
Add this dynamic block to your org file:
...
You can track progress at different levels:
...
** Progress by Scene
#+BEGIN: progress-by-act :match "LEVEL=3+ignore" :title "Scene"
#+END:
#+end_example
