...
(defconst org-scribe-messages-en
  '(
    ...
    (compile-unsafe-scene-break . "org-scribe-compile-scene-break must not begin with `*' or `#' (it is %s); see its docstring")
...
(defconst org-scribe-messages-es
  '(
    ...
    (compile-unsafe-scene-break . "org-scribe-compile-scene-break no puede empezar por `*' ni por `#' (vale %s); consulta su docstring")
