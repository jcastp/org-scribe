...
(defconst org-scribe-messages-en
  '(
    ...
    (compile-style-unsupported . "Compile style `%s' is not available yet; only `clean' is")
...
(defconst org-scribe-messages-es
  '(
    ...
    (compile-style-unsupported . "El estilo de compilación `%s' todavía no está disponible; solo lo está `clean'")
