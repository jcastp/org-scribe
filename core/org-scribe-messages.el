...
(defconst org-scribe-messages-en
  '(
    ...
    (compile-backend-missing . "Cannot compile to %s: the `%s' library is not available")
...
(defconst org-scribe-messages-es
  '(
    ...
    (compile-backend-missing . "No se puede compilar a %s: la biblioteca `%s' no está disponible")
