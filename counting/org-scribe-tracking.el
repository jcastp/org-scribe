;;; org-scribe-tracking.el --- Progress tracking for org-scribe -*- lexical-binding: t; -*-
...
Requires org-tracktable package to be installed."
  (interactive)
  (org-scribe-when-feature org-tracktable
    (org-tracktable-write)))

(provide 'org-scribe-tracking)

;;; org-scribe-tracking.el ends here
